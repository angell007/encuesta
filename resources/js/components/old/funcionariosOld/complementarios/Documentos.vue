<template>
  <div class="documents">
      ...
      <div class="row">
        <target-component @getFiles="getFiles"
  ...
  methods: {
    ...
    getConfig() {
      return {
        ...
        dictDefaultMessage: "Aquí podrá cargar los documentos que requiere tener del funcionario, como su contrato, afiliaciones hoja de vida, etc.",
        addRemoveLinks: true,
        maxFiles: 4,
        maxFilesize: 3,
        chunkSize: 500,
