        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card-partial">
              <div class="card-body">
                <div class="row">
                  <h1 class="font-weight-bold text-muted col-md-6 subtitle">
                    Datos Básicos
                  </h1>
                ...
                <div class="row">
                  <div class="col-md-5">
                    <p class="font-weight-bold text-muted text-right">
                      Razón social
                    </p>
                  </div>
                  <div class="col-md-6">
            ...
            <div class="card-partial">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <p class="item">
                      {{ empresa.auxilio_transporte | moneda }}
                    </p>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6 offset-1">
                    <p class="font-weight-bolder text-muted text-right">
                      Hora Fin Noche
                    </p>
                  </div>
                  <div class="col-md-4">
