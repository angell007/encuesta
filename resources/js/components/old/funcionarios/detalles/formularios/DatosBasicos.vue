<template>
  <form @submit.prevent="validarAntesDeEnviar1" class="row">
    ...
    <div class="form-group col-md-10 text-center">
      ...
      <div class="form-group row">
        <label class="custom-label text-right col-form-label col-md-3 offset-1" for="sexo">Género</label>
        <select
          name="sexo"
      ...
      <div class="form-group row">
        <label class="custom-label text-right col-form-label col-md-3 offset-1" for>Tipo de Sangre</label>
        <select
          v-model="funcionarioEditar.tipo_sangre"
          class="form-control custom-control col-md-6"
        >
          <option v-for="(tipo, index) in tipoSangre" :key="index" :value="tipo">{{ tipo }}</option>
        </select>
      </div>
      ...
      <div class="form-group text-right">
        <input type="submit" class="btn btn-secondary raised" value="Actualizar" id="btnSubmit" />
      </div>
    </div>
  </form>
</template>
