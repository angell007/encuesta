<template>
  <form @submit.prevent="validarAntesDeEnviar">
    <div class="form-row">
      ...
      <div class="form-group col-md-6" v-if="turnoActual == 'Fijo'">
...
export default {
  ...
  methods: {
    ...
    putDatosEmpresa() {
      this.funcionarioEditar.turno_fijo_id =
        this.turnoActual == "Fijo" ? this.turnoFijoActual.id : 0;
      ...
      axios
        ...
        .then((respuesta) => {
          console.log(this.funcionarioEditar, this.turnoFijoActual);
          ...
          axios
            ...
            .then((datos) => {
              this.funcionarioEditarCustom = datos.data;
              ...
              if (this.funcionarioEditarCustom.tipo_turno == "Fijo")
                this.funcionarioEditar.turno_fijo = this.funcionarioEditarCustom.turno_fijo;
            });
    ...
    getDependencias() {
      axios
        ...
        .then((datos) => {
          ...
          this.getCargos(this.dependenciaActual);
    ...
    getDependenciaAndCargoActual(arrayDatos, datoComparacion) {
      return arrayDatos.find((dato) => {
        return (
          dato.id ===
          parseInt(this.funcionarioEditar.contractultimate[datoComparacion])
        );
      });
    },
