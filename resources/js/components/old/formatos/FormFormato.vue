  ...
  <div>
    ...
    <div class="col-md-12 text-justify">
      ...
      <div class="form-group">
        ...
        <input
          v-model="formulario.informacion"
          type="text"
          name="informacion"
          v-validate="'required'"
          data-vv-as="Nombres"
      ...
      <div class="form-group col-md-12 text-center">
        <img id="imageOutput2" src alt=" Firma digital " class="d-block m-auto" />
...
export default {
  ...
  methods: {
    ...
    createdFormato(modal) {
      ...
      axios
        .post(`/api/${localStorage.getItem("tenant")}/formatos`, data)
        .then(datos => {});
    }
  }
};
