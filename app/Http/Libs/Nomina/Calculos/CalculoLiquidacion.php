...
class CalculoLiquidacion
{
    ...
    public function __construct($salarioBase = 0, $auxilioTransporte = 0, $fechaIngreso, $fechaRetiro = null)
    {
    ...
    {
        $this->totalLiquidacion = $this->totalVacaciones + $this->totalCesantias + $this->totalInteresesCesantias + $this->totalPrima + $this->totalIngresos - $this->totalEgresos;
    }
