...
class NominaNovedades extends PeriodoPago
{
    ...
    {
        self::$funcionario = Funcionario::with('contractultimate.cargo')->find($id);
        return new self;
    }
    ...
    public function fromTo($fechaInicio, $fechaFin)
    {
        ...
        $this->calculoNovedades = new CalculoNovedades(self::$funcionario->contractultimate->salario, $this->fechaInicio, $this->fechaFin);
